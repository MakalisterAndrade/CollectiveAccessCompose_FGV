...
?>
				...
				<?php print caNavLink($this->request, '<div class="logo-con">'.caGetThemeGraphic($this->request, 'fgv-logo.svg', array("class" => "logo", "alt" => "IC Dados Abertos", "role" => "banner")).'</div>'.caGetThemeGraphic($this->request, 'ic_logo.png', array("class" => "logo-title", "alt" => "IC Dados Abertos", "role" => "banner")), "logo-wrap", "", "", ""); ?>
				<!--<a href="https://www.trcnyc.org" class="logo-wrap" rel="home"><div class="logo-con"><?php print caGetThemeGraphic($this->request, 'ic_logo.png', array("class" => "logo", "alt" => "IC Dados Abertos", "role" => "banner")); ?></div><?php
                	print caGetThemeGraphic($this->request, 'ic_logo.png', array("class" => "logo-title", "alt" => "IC Dados Abertos", "role" => "banner")); ?></a>-->
			</div>
