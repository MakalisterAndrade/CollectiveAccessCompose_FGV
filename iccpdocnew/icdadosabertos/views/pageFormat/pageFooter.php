			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 logoCol">
						<a href="https://www.trcnyc.org" target="_blank"><?php print caGetThemeGraphic($this->request, 'ic_logo.png', array("class" => "logo", "alt" => "Logo FGV")); ?></a>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-sm-12 col-md-9 col-lg-7">
						<div class="learnLinks">
							...
							<a class="affiliate-logo" href="https://cpdoc.fgv.br/"><?php print caGetThemeGraphic($this->request, 'fgv-logo.svg', array("class" => "fgv-logo", "alt" => "Logo FGV")); ?></a>
						</div>
						<div class="daySchool">
