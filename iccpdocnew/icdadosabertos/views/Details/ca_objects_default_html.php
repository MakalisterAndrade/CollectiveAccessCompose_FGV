...
// Exibe o metadado image_ocr se estiver presente

if ($t_object->get('ca_objects.image_ocr')) {

echo '<div class="unit"><h6>Image OCR:</h6>';

echo $t_object->get('ca_objects.image_ocr');
