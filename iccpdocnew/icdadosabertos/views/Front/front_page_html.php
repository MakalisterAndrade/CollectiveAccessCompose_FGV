		...
		<div class="row">
			<div class="col-sm-12 col-md-6 col-md-offset-3">
				...
				<div class="heroSearch">
					<H1>
						<div class="line1">Bem vindo</div>
						<div class="line2">Projeto Piloto</div>
						<div class="line3">IC Dados Abertos CPDOC</div>
					</H2>
			...
			<div class="blog-index">
				<div class="posts-con">
					...
					<div href="#" class="indiv-blog">
						...
						<div class="post-details">
						<h4 class="post-title"><?php print caNavLink($this->request, "Entrevistas", "", "", "Browse", "objects", array("facet" => "type_facet", "id" => 25)); ?></h4>
							<p class="post-excerpt">{{{home_recordings_intro}}}</p>
							<a class="fig-text-btn" href="<?php print caNavUrl($this->request, "", "Browse", "objects", array("facet" => "type_facet", "id" => 25)); ?>">More</a>
						</div>
					</div>
				</div>
			</div>
